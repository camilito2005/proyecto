...
class Registro
{
    ...
    public function registrar($dni, $nombre, $apellido, $telefono, $direccion, $correo, $contraseña, $rol)
    {
        ...
        if (strlen($contraseña) >= 6) {
            ...
            if (strlen($contraseña) < 6) {
                require_once "../vistas/usuarios/formulario_registro.php";
                echo "la contraseña debe tener mas de 6 digitos";
            }
        }
    }
    public function actualizar_usuarios($id, $nombre, $apellido, $telefono, $direccion, $correo, $contraseña, $rol)
    {
        ...
        $sql = $conexion->query("UPDATE usuarios SET nombre= '$nombre',apellido='$apellido',telefono='$telefono',direccion ='$direccion',correo='$correo',contraseña ='$contraseña',id_rol = '$rol' WHERE id_personas = $id");
    ...
    {
        include "../conexion.php";
        $consulta = mysqli_query($conexion, "DELETE FROM usuarios WHERE id_personas = $id");
    ...
    {
        include "../../conexion.php";
        $sql = mysqli_query($conexion, "SELECT * FROM `usuarios` INNER JOIN cargo ON usuarios.id_rol = cargo.id;");
